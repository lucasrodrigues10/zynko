using Zynko.Application.Common.Models;
using Zynko.Application.TodoItems.Commands.CreateTodoItem;
using Zynko.Application.TodoItems.Commands.DeleteTodoItem;
using Zynko.Application.TodoItems.Commands.UpdateTodoItem;
using Zynko.Application.TodoItems.Commands.UpdateTodoItemDetail;
using Zynko.Application.TodoItems.Queries.GetTodoItemsWithPagination;
